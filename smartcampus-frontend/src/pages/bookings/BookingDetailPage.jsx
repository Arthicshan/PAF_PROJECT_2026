        ...
        {loading ? (
          ...
          <div className="space-y-5">
            ...
            <div className={`${card} p-5`}>
              ...
              <div className={`grid grid-cols-2 lg:grid-cols-4 gap-3 mt-4 pt-4 ${divider}`}>
                <div>
                  <p className={`text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}>Date</p>
                  <p className={`text-sm font-medium ${dark ? 'text-white' : 'text-gray-900'}`}>{booking.date}</p>
                </div>
                <div>
                  <p className={`text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}>Time</p>
                  <p className={`text-sm font-medium ${dark ? 'text-white' : 'text-gray-900'}`}>{booking.startTime} - {booking.endTime}</p>
                </div>
                <div>
                  <p className={`text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}>Requested By</p>
                  <p className={`text-sm font-medium truncate ${dark ? 'text-white' : 'text-gray-900'}`}>{booking.userName || '-'}</p>
                </div>
                <div>
                  <p className={`text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}>Booking ID</p>
                  <p className={`text-sm font-medium truncate ${dark ? 'text-white' : 'text-gray-900'}`}>{booking.id}</p>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-5">
              ...
              <div className="space-y-4">
                  ...
                  <div className={`${card} p-5`}>
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium bg-green-600 hover:bg-green-500 text-white transition-all disabled:opacity-60"
                      >
                      ...
                      <button
                        ...
                        disabled={!!actionLoading}
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium bg-red-600 hover:bg-red-500 text-white transition-all disabled:opacity-60"
                      >
                ...
                {isOwner && (status === 'PENDING' || status === 'APPROVED') && (
                  <div className={`${card} p-5`}>
                    <h3 className={`text-xs font-semibold uppercase tracking-wider mb-3 ${dark ? 'text-gray-500' : 'text-gray-400'}`}>My Actions</h3>
                    <div className="space-y-2">
                      <button
